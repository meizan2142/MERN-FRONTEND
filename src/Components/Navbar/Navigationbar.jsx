...
export const Navigationbar = () => {
    ...
    const navLinksLg = <>
        ...
        <li>
            <NavLink className={({ isActive }) => isActive ? 'group flex  cursor-pointer flex-col text-red-500 font-bold' : "group flex  cursor-pointer flex-col"} to='/dashboard'>Dashboard<span className="mt-[2px] h-[3px] w-[0px] rounded-full bg-red-500 transition-all duration-300 group-hover:w-full"></span></NavLink>
        </li>
    </>
    const navLinksSm = <>
